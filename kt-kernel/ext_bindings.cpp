...
void bind_moe_sft_module(py::module_& moe_module, const char* name) {
  ...
  py::class_<MoeClass, MoE_Interface, std::shared_ptr<MoeClass>>(moe_module, name)
      ...
      .def("forward_sft_task", &MoeBindings::ForwardSFTBindings::cpuinfer_interface, py::arg("qlen"), py::arg("k"),
           py::arg("expert_ids"), py::arg("weights"), py::arg("input"), py::arg("output"),
           py::arg("save_for_backward"), py::arg("autofree") = false)
...
PYBIND11_MODULE(kt_kernel_ext, m) {
  ...
  py::class_<CPUInfer>(m, "CPUInfer")
      ...
      .def("rethrow_pending_callback_exception",
           &CPUInfer::rethrow_pending_callback_exception)
