...
KT SFT pins torch 2.13.0. Keep torchvision and torchaudio on the matching
0.28.0/2.11.0 releases.
...
- Conv3D compatibility activation through the KT VLM compatibility path;
...
2. The fallback patches only the supported Conv3D instances on the loaded KT
